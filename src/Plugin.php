...
class Plugin {
  ...
  public static function init() {
    if (function_exists('register_field_group')) {
      ...
      elseif (MOEVE_SHOP === 'WOPA') {
        $fields = [
          ['zubehoer', 'Zubehör', true, null],
          ['pflegemittel', 'Pflegemittel', true, null],
          ['accessoires_und_deko', 'Accessoires & Deko', true, null]
        ];
      }
      elseif (MOEVE_SHOP === 'LART') {
        $fields = [
          ['leuchtmittel', 'Leuchtmittel', true, null],
          ['led_lampen', 'LED-Lampen', true, null],
          ['leuchtenzubehoer', 'Leuchtenzubehör', true, null],
          ['zubehoer', 'Zubehoer', true, null],
          ['zubehoer_occhio', 'Zubehör Occhio', true, null],
          ['zubehoer_top_light', 'Zubehör Top Light', true, null],
          ['zubehoer_bopp', 'Zubehör Bopp', true, null],
          ['baldachine', 'Baldachine', true, null],
          ['leuchtenschirme', 'Leuchtenschirme', true, null]
        ];
      }
      else {
        // No acf registered.
  ...
  public static function register_acf(array $fields) {
    ...
    foreach ($fields as $field) {
      $fieldParameters[] = Helper::getFieldParameters($field[0], $field[1], $field[2], $field[3]);
    }
