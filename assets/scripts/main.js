...
jQuery(document).ready(function($) {
  ...
  $(document).on('change', '.related-accessories select, .related-accessories--summary select', function () {
   ...
   */
  $(document).on('click', '#reset_related_accessories', function(e) {
    e.preventDefault();
  ...
  /**
  * Reload related accessories for ajax add to cart
  */
  $(document).on('reloadRelatedAccessories', function () {
...
jQuery(document).ready(function ($) {
  ...
  */
  $(document).on('reloadRelatedAccessories', function () {
    $('.woocommerce-product-gallery .label-wrap').appendTo('.woocommerce-product-gallery');
    // Forces related accessories notice slideshow to be shown on page load.
    $('.related-accessories select').change();
